...
<div class="content">
    ...
    <div class="form">
        ...
        <form method="post" action="/books/${bookDto.id}/edit">
            <label>Name:
            ...
            <p>Cover:</p>
            <input name="cover" type="radio" value="HARD" id="radio_hard" <c:if test="${bookDto.cover == 'HARD'}">
                   checked </c:if>>
            <label for="radio_hard">HARD</label>
            <br>

            <input name="cover" type="radio" value="SOFT" id="radio_soft" <c:if test="${bookDto.cover == 'SOFT'}">
                   checked </c:if>>
            <label for="radio_soft">SOFT</label>
            <br>

            <input name="cover" type="radio" value="SPECIAL" id="radio_special" <c:if
                    test="${bookDto.cover == 'SPECIAL'}"> checked </c:if>>
